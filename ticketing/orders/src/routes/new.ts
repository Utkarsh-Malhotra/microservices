...
import { BadRequestErrors, NotFoundError, OrderStatus, requireAuth,validateRequest } from '@utktickets/common'
...
router.post('/api/orders',requireAuth,[
    ...
    .not()
    .isEmpty()
    .custom((input: string) => mongoose.Types.ObjectId.isValid(input)) //no need to do this step
